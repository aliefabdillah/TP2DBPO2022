...
while (list($id_divisi, $nama_divisi) = $divisi->getResult()) {
    ...
    "<tr>
        ...
        <td>". $nama_divisi ."</td>
        <td>
        <a href='details.php?id_edit_div=" . $id_divisi .  "' class='btn btn-warning'> Update </a>
        <a href='details.php?id_hapus_div=" . $id_divisi . "' class='btn btn-danger'> Hapus </a>
        </td>
    </tr>";
    $no++;
}
...
while (list($id_bidang, $jabatan, $id_divisi) = $bidang->getResult()) {
    ...
    "<tr>
        ...
        <td>
        <a href='details.php?id_edit_bid=" . $id_bidang .  "' class='btn btn-warning'> Update </a>
        <a href='details.php?id_hapus_bid=" . $id_bidang . "' class='btn btn-danger'> Hapus </a>
        </td>
    </tr>";
    $no++;
}
...
while (list($nim, $nama, $semester, $foto, $id_bidang) = $pengurus->getResult()) {
    ...
    "<tr>
        ...
        <td>
        <a href='details.php?id_edit=" . $nim .  "' class='btn btn-warning'> Update </a>
        <a href='details.php?id_hapus=" . $nim . "' class='btn btn-danger'> Hapus </a>
        </td>
    </tr>";
}
